module.exports = (function () {
  ...
  validateEventOptions = function (eventOptions) {
  ...
  toFile = function (data, filePath, callback) {
    fs.writeFile(filePath, data, function (err, destination) {
